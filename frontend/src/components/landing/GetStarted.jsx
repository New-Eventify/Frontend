  ...
  return (
    <div className="relative overflow-hidden inner h-72 flex justify-center items-center">
      ...
      <motion.div
        ...
        className="text-center grid justify-items-center relative"
      >
        ...
        <Link>
          <button className="flex items-center gap-1 py-3 px-6 text-2xl rounded-md bg-appNavyBlue text-appYellow">
            Get Started
