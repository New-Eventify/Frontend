    ...
    <div className="h-screen relative flex justify-center items-center p-4">
      ...
      <div className="relative w-max container mx-auto">
        <motion.h1
          ...
          className="text-white mb-6 text-center text-4xl sm:text-6xl lg:text-7xl max-w-[20ch]"
        >
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: "easeInOut" }}
          className="shadow-lg bg-white rounded-md w-full flex p-2 md:p-3 max-w-5xl h-10 md:h-14"
        >
          <div className="flex md:gap-2 text-appDarkText text-sm md:text-lg items-center w-3/4">
            <Icon
          ...
          <div className="text-xs md:text-sm md:w-1/4 border-l border-placeholderGray md:pl-4 relative">
            ...
            {isDropdown && (
              <div className="absolute w-full left-2 top-10 md:top-12 bg-white border border-placeholderGray rounded shadow-lg z-10">
                {locations.map((loc) => (
                  <div
                    key={loc}
